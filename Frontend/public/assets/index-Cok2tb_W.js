...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Zl(){return new Ft({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qo(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function $l(){return new Ft({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qo(),fragmentShader:`
...
#define LOW_PRECISION`),e}function cg(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Dc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Lc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===En&&(e="SHADOWMAP_TYPE_VSM"),e}function hg(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case qi:case ji:e="ENVMAP_TYPE_CUBE";break;case zr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ug(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ji:e="ENVMAP_MODE_REFRACTION";break}return e}function dg(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ic:e="ENVMAP_BLENDING_MULTIPLY";break;case Jh:e="ENVMAP_BLENDING_MIX";break;case Qh:e="ENVMAP_BLENDING_ADD";break}return e}function fg(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function pg(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=cg(t),c=hg(t),u=ug(t),d=dg(t),f=fg(t),m=tg(t),g=ng(r),v=s.createProgram();let p,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(hs).join(`
`)),a=Co(a),a=lc(a,t),a=cc(a,t),o=Co(o),o=lc(o,t),o=cc(o,t),a=hc(a),o=hc(o),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
`,p=[m,"#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+p,h=["#define varying in",t.glslVersion===dl?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===dl?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+h);const b=T+p+a,y=T+h+o,L=rc(s,s.VERTEX_SHADER,b),C=rc(s,s.FRAGMENT_SHADER,y);s.attachShader(v,L),s.attachShader(v,C),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function R(P){if(i.debug.checkShaderErrors){const H=s.getProgramInfoLog(v).trim(),B=s.getShaderInfoLog(L).trim(),X=s.getShaderInfoLog(C).trim();let K=!0,W=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,L,C);else{const Z=oc(s,L,"vertex"),V=oc(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}$i.BlurDirectionX=new pe(1,0);$i.BlurDirectionY=new pe(0,1);class Ss extends He{constructor(){super(Ss.Geometry,new Jt({opacity:0,transparent:!0})),this.isLensflare=!0,this.type="Lensflare",this.frustumCulled=!1,this.renderOrder=1/0;const e=new w,t=new w,n=new Ul(16,16),s=new Ul(16,16);let r=en;const a=Ss.Geometry,o=new Er({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
				...
				}`,depthTest:!1,depthWrite:!1,transparent:!1}),c=new He(a,o),u=[],d=es.Shader,f=new Er({name:d.name,uniforms:{map:{value:null},occlusionMap:{value:s},color:{value:new k(16777215)},scale:{value:new pe},screenPosition:{value:new w}},vertexShader:d.vertexShader,fragmentShader:d.fragmentShader,blending:Rr,transparent:!0,depthWrite:!1}),m=new He(a,f);this.addElement=function(T){u.push(T)};const g=new pe,v=new pe,p=new id,h=new Je;this.onBeforeRender=function(T,b,y){T.getCurrentViewport(h);const L=T.getRenderTarget(),C=L!==null?L.texture.type:en;r!==C&&(n.dispose(),s.dispose(),n.type=s.type=C,r=C);const R=h.w/h.z,I=h.z/2,S=h.w/2;let M=16/h.w;if(g.set(M*R,M),p.min.set(h.x,h.y),p.max.set(h.x+(h.z-16),h.y+(h.w-16)),t.setFromMatrixPosition(this.matrixWorld),t.applyMatrix4(y.matrixWorldInverse),!(t.z>0)&&(e.copy(t).applyMatrix4(y.projectionMatrix),v.x=h.x+e.x*I+I-8,v.y=h.y+e.y*S+S-8,p.containsPoint(v))){T.copyFramebufferToTexture(n,v);let P=o.uniforms;P.scale.value=g,P.screenPosition.value=e,T.renderBufferDirect(y,null,a,o,c,null),T.copyFramebufferToTexture(s,v),P=l.uniforms,P.scale.value=g,P.screenPosition.value=e,T.renderBufferDirect(y,null,a,l,c,null);const H=-e.x*2,B=-e.y*2;for(let X=0,K=u.length;X<K;X++){const W=u[X],Z=f.uniforms;Z.color.value.copy(W.color),Z.map.value=W.texture,Z.screenPosition.value.x=e.x+H*W.distance,Z.screenPosition.value.y=e.y+B*W.distance,M=W.size/h.w;const V=h.w/h.z;Z.scale.value.set(M*V,M),f.uniformsNeedUpdate=!0,T.renderBufferDirect(y,null,a,f,m,null)}}},this.dispose=function(){o.dispose(),l.dispose(),f.dispose(),n.dispose(),s.dispose();for(let T=0,b=u.length;T<b;T++)u[T].texture.dispose()}}}class es{constructor(e,t=1,n=0,s=new k(16777215)){this.texture=e,this.size=t,this.distance=n,this.color=s}}es.Shader={name:"LensflareElementShader",uniforms:{map:{value:null},occlusionMap:{value:null},color:{value:null},scale:{value:null},screenPosition:{value:null}},vertexShader:`
...
${p.info}`)}),T.querySelector(".follow-moon-btn").addEventListener("click",R=>{R.stopPropagation();const I=lt[e];I.moons&&I.moons[h]&&(Y_(I.moons[h].mesh,p,i.name),Gr())}),m.appendChild(T)})):d.style.display="none",t.style.display="block",Th(e)}let Ar=null,pi=null,_i=null;function Th(i){const e=document.getElementById("followPlanetBtn"),t=document.getElementById("stopFollowBtn"),n=lt[i];Ar=i,pi===n&&_i==="planet"?(e.textContent="🛑 STOP FOLLOWING",e.classList.add("following"),t&&(t.style.display="block",t.classList.add("active"))):(e.textContent="🎯 FOLLOW PLANET",e.classList.remove("following"),t&&!pi&&(t.style.display="none",t.classList.remove("active")))}function X_(i){const e=cn[i],t=lt[i];pi=t,_i="planet",di=t;const n=Math.max(e.size*8,15);Es.set(n,n*.5,n),Gn.set(0,0,0),Ds.set(0,0,0),Oe.enableZoom=!0,Oe.minDistance=n*.5,Oe.maxDistance=n*3,Th(i),console.log(`Now following ${e.name}`)}function Y_(i,e,t){pi=i,_i="moon",di={mesh:i};const n=Math.max(e.size*12,8);Es.set(n,n*.5,n),Gn.set(0,0,0),Ds.set(0,0,0),Oe.enableZoom=!0,Oe.minDistance=n*.3,Oe.maxDistance=n*4;const s=document.getElementById("stopFollowBtn");s&&(s.style.display="block",s.classList.add("active")),console.log(`Now following ${e.name} of ${t}`)}function bh(){pi=Pn,_i="sun",di={mesh:Pn};const i=new w;Pn.getWorldPosition(i),pt.position.set(i.x+25,i.y+12,i.z+25),Oe.target.copy(i),Oe.enableZoom=!0,Oe.minDistance=10,Oe.maxDistance=100,Gn.set(0,0,0),Ds.set(0,0,0);const e=document.getElementById("stopFollowBtn");e&&(e.style.display="block",e.classList.add("active")),console.log("Now following the Sun (zoom enabled)")}function Vr(){di=null,pi=null,_i=null,Gn.set(0,0,0),Ds.set(0,0,0),pt.position.set(0,30,70),Oe.target.set(0,0,0),Oe.reset(),Oe.enableZoom=!0,Oe.minDistance=.1,Oe.maxDistance=1e3,Gr();const i=document.getElementById("followPlanetBtn"),e=document.getElementById("stopFollowBtn");i&&(i.textContent="🎯 FOLLOW PLANET",i.classList.remove("following")),e&&(e.style.display="none",e.classList.remove("active")),console.log("Stopped following and reset view")}function Gr(){const i=document.getElementById("planetInfoCard");i.style.display="none"}function q_(){St&&Qe.remove(St);const i=new ys(5.2,8,32),e=new Jt({color:16777215,transparent:!0,opacity:0,side:qt});St=new He(i,e),St.lookAt(pt.position),Qe.add(St)}function Wr(){if(Ht){ts();return}Ht=!0,hn=0,kn=0,zi.earth=lt[2].pivot.rotation.y,zi.moon=lt[2].moons[0].pivot.rotation.y,wr=[{position:new w(0,20,40),target:new w(0,0,0)},{position:new w(25,5,0),target:new w(15,0,0)},{position:new w(16,2,3),target:new w(15,0,0)},{position:new w(14,1,1),target:new w(0,0,0)},{position:new w(15,8,5),target:new w(15,0,0)}],j_(),q_();const i=document.getElementById("eclipseTourInfo");if(i){i.style.display="block",i.style.opacity="0.98";const s=i.querySelector("h3"),r=i.querySelector('div[style*="font-size:40px"]');Dn==="solar"?(s&&(s.textContent="Solar Eclipse: Cinematic Tour"),r&&(r.textContent="🌒")):(s&&(s.textContent="Lunar Eclipse: Cinematic Tour"),r&&(r.textContent="🌕"))}const e=document.getElementById("solarEclipseTourBtn"),t=document.getElementById("lunarEclipseTourBtn");Dn==="solar"&&e?(e.classList.add("active"),e.textContent="⏹️ Stop Solar Tour"):Dn==="lunar"&&t&&(t.classList.add("active"),t.textContent="⏹️ Stop Lunar Tour"),document.querySelectorAll(".controls, .celestial-panel, .info, #planetInfoCard, #showUIBtn").forEach(s=>{s&&(s.style.transition="opacity 0.6s ease, transform 0.6s ease",s.style.opacity="0",s.style.pointerEvents="none",s.classList.add("ui-hidden"))}),oi&&oi.material&&(oi.material.opacity=.65),console.log("🌒 Eclipse Tour Started! Enjoy the cinematic journey...")}function j_(){lt[2].pivot.rotation.y=0,lt[2].moons&&lt[2].moons[0]&&(Dn==="solar"?lt[2].moons[0].pivot.rotation.y=0:lt[2].moons[0].pivot.rotation.y=Math.PI)}function K_(){if(!Ht)return;if(kn+=16,kn>=Nr&&(hn++,kn=0,hn>=wr.length)){ts();return}Z_();const i=wr[hn],e=kn/Nr,t=.5*(1-Math.cos(e*Math.PI));if(hn>0){const n=wr[hn-1];pt.position.lerpVectors(n.position,i.position,t);const s=new w;s.lerpVectors(n.target,i.target,t),Oe.target.copy(s)}else pt.position.lerp(i.position,.02),Oe.target.lerp(i.target,.02);$_(),Oe.update()}function Z_(){const i=document.getElementById("eclipsePhaseTitle"),e=document.getElementById("eclipsePhaseDesc"),t=document.getElementById("eclipseProgress");if(!i||!e||!t)return;const n=kn/Nr*100;t.style.width=`${n}%`;const a=Dn==="solar"?[{title:"Phase 1: Getting Ready (Alignment)",desc:"We start far away so you can see the Sun, Earth and Moon line up. Think of it as three friends standing in a row — from our view, they look perfect when they line up. This helps you see how the solar eclipse can happen."},{title:"Phase 2: First Contact (Moon Moves In)",desc:"Now the Moon slowly moves between the Earth and the Sun. You will see the Sun start to look a little bitten — that's the Moon covering it. Take your time, watch the motion."},{title:"Phase 3: Approaching Totality (Shadow Grows)",desc:"The Moon's shadow stretches over the Earth. The light will change and things will get dimmer — like when clouds pass over the sun. We'll move closer so you can feel the scale."},{title:"Phase 4: Total Solar Eclipse (The Corona)",desc:"For a brief magical moment the Sun is hidden and we can see the corona — a beautiful glowing ring. It's one of the most stunning sights in space. We'll slow down so you can enjoy every second."},{title:"Phase 5: The Shadow Passes (Ending)",desc:"The Moon moves on and sunlight returns. The shadow sweeps away and everything goes back to normal. We'll pull back so you can see the full scene again."}]:[{title:"Phase 1: Getting Ready (Alignment)",desc:"We start far away so you can see the Sun, Earth and Moon line up. Think of it as three friends standing in a row — but this time Earth is in the middle, blocking sunlight from reaching the Moon. This helps you see how the lunar eclipse can happen."},{title:"Phase 2: Entering Earth's Shadow (Penumbra)",desc:"Now the Moon slowly moves into Earth's shadow. You will see the Moon start to look a little darker — that's Earth's shadow covering it. The Moon doesn't disappear, it just gets dimmer as Earth blocks the sunlight."},{title:"Phase 3: Deeper Shadow (Umbra Approaches)",desc:"The Moon moves deeper into Earth's shadow. The light will change and the Moon will get much darker — like when you stand in someone's shadow. We'll move closer so you can see how Earth completely blocks direct sunlight."},{title:"Phase 4: Total Lunar Eclipse (Complete Shadow)",desc:"For a moment the Moon is completely in Earth's shadow! Even though no direct sunlight reaches it, the Moon doesn't completely disappear. Some light still reaches it after bending through Earth's atmosphere, which is why we can still see it faintly."},{title:"Phase 5: Leaving the Shadow (Ending)",desc:"The Moon moves out of Earth's shadow and returns to its normal bright color. The shadow passes away and everything goes back to normal. We'll pull back so you can see the full scene again."}];hn<a.length&&(i.textContent=a[hn].title,e.textContent=a[hn].desc)}function $_(){const i=kn/Nr;switch(hn){case 0:St&&(St.material.opacity=0);break;case 1:Oi.intensity=.5-i*.25;break;case 2:Oi.intensity=.4-i*.35,St&&(St.material.opacity=i*.3,St.lookAt(pt.position));break;case 3:Oi.intensity=.08,St&&(St.material.opacity=.85,St.lookAt(pt.position));break;case 4:Oi.intensity=.08+i*.5,St&&(St.material.opacity=.85-i*.9);break}}function ts(){Ht=!1,hn=0,kn=0,zi.earth!==void 0&&(lt[2].pivot.rotation.y=zi.earth),zi.moon!==void 0&&lt[2].moons&&lt[2].moons[0]&&(lt[2].moons[0].pivot.rotation.y=zi.moon),Oi.intensity=.5,St&&(Qe.remove(St),St=null);const i=document.getElementById("eclipseTourInfo");i&&(i.style.display="none",i.style.opacity="0"),document.querySelectorAll(".controls, .celestial-panel, .info, #planetInfoCard, #showUIBtn").forEach(s=>{s&&(s.style.opacity="1",s.style.pointerEvents="auto",s.classList.remove("ui-hidden"))}),oi&&oi.material&&(oi.material.opacity=.9),Oe.enableDamping=!0;const t=document.getElementById("solarEclipseTourBtn"),n=document.getElementById("lunarEclipseTourBtn");t&&(t.classList.remove("active"),t.textContent="🌒 Solar Eclipse Tour"),n&&(n.classList.remove("active"),n.textContent="🌕 Lunar Eclipse Tour"),console.log("Eclipse Tour ended. Welcome back to normal view!")}function J_(i){if(i.target.closest(".controls")||i.target.closest(".celestial-panel")||i.target.closest(".info")||i.target.closest(".planet-info-card"))return;Ba.x=i.clientX/window.innerWidth*2-1,Ba.y=-(i.clientY/window.innerHeight)*2+1,Rc.setFromCamera(Ba,pt);let e=[];const t=lt.map(r=>r.mesh);e=e.concat(t);let n=[];lt.forEach((r,a)=>{r.moons&&r.moons.length>0&&r.moons.forEach(o=>{n.push({mesh:o.mesh,moonData:o,planetIndex:a,planetName:cn[a].name})})}),e.push(Pn);const s=Rc.intersectObjects(e);if(s.length>0){const r=s[0].object;if(r===Pn){bh();return}const a=t.indexOf(r);if(a!==-1){const o=cn[a];W_(o,a)}}else Gr()}const Rc=new nd,Ba=new pe;window.addEventListener("click",J_);document.getElementById("closePlanetInfo").addEventListener("click",Gr);document.getElementById("followPlanetBtn").addEventListener("click",()=>{Ar!==null&&(pi===lt[Ar]&&_i==="planet"?Vr():X_(Ar))});const Cc=document.getElementById("stopFollowBtn");Cc&&Cc.addEventListener("click",()=>{Vr()});const Pc=document.getElementById("followSunBtn");Pc&&Pc.addEventListener("click",()=>{bh()});document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>{el()},1e3)});window.addEventListener("keydown",i=>{const e=document.getElementById("chatbotInput");if(document.activeElement!==e)switch(i.key.toLowerCase()){case" ":i.preventDefault();const t=document.getElementById("pauseBtn");t&&t.click();break;case"r":const n=document.getElementById("resetBtn");n&&n.click();break;case"f":Vr();break;case"o":const s=document.getElementById("orbitsBtn");s&&s.click();break;case"a":const r=[document.getElementById("mainAsteroidsBtn"),document.getElementById("trojansBtn"),document.getElementById("kuiperBtn"),document.getElementById("scatteredBtn")];let a=!1;for(let v=0;v<r.length;v++)if(r[v]&&r[v].classList.contains("active")){r[v].click();const p=(v+1)%r.length;r[p]&&r[p].click(),a=!0;break}!a&&r[0]&&r[0].click();break;case"m":const o=document.getElementById("moonsBtn");o&&o.click();break;case"h":const l=document.getElementById("hideUIBtn"),c=document.getElementById("showUIBtn");l&&c&&(c.style.display==="block"?c.click():l.click());break;case"p":const u=document.getElementById("musicBtn"),d=document.getElementById("muteMusicBtn");li&&d?d.click():!li&&u&&u.click();break;case"+":case"=":i.preventDefault();const f=document.getElementById("speedControl");if(f){const v=parseFloat(f.value),p=Math.min(10,v+.5);f.value=p,f.dispatchEvent(new Event("input"))}break;case"-":i.preventDefault();const m=document.getElementById("speedControl");if(m){const v=parseFloat(m.value),p=Math.max(0,v-.5);m.value=p,m.dispatchEvent(new Event("input"))}break;case"b":i.preventDefault(),Rt=!Rt;const g=document.getElementById("bloomModeBtn");g&&(g.textContent=Rt?"Auto Bloom":"Manual Bloom",g.classList.toggle("active",Rt)),Rt?(console.log("🎛️ Switched to manual bloom mode (slider control)"),kt.strength=Ts):console.log("🌟 Switched to automatic bloom mode (dynamic with distance)");break}});Oe.enablePan=!0;Oe.enableZoom=!0;Oe.enableRotate=!0;Oe.minDistance=8;Oe.maxDistance=200;Oe.minPolarAngle=0;Oe.maxPolarAngle=Math.PI;Oe.autoRotate=!1;Oe.autoRotateSpeed=.3;Oe.target.set(0,0,0);pt.position.set(0,30,70);window.addEventListener("resize",()=>{pt.aspect=window.innerWidth/window.innerHeight,pt.updateProjectionMatrix(),tn.setSize(window.innerWidth,window.innerHeight),Ps.setSize(window.innerWidth,window.innerHeight),Mh(),yh()});
